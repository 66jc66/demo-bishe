!function (t, e) {
    ...
    function v() {
        ...
        return Object.getOwnPropertyNames(e).forEach(function (t) {
            var n = e[t];
            -1 !== t.indexOf("aria-") || "role" === t || "type" === t ? (Ye.warn(Ge($e, t, n)), i.setAttribute(t, n)) : "textContent" === t ? y(i, n) : i[t] = n
    ...
    function K(t, e, n) {
        ...
        if ("string" == typeof e && (e = {
            type: e,
            target: t
        }), e = z(e), r.dispatcher && r.dispatcher.call(t, e, n), i && !e.isPropagationStopped() && !0 === e.bubbles) K.call(null, i, e, n); else if (!i && !e.defaultPrevented) {
            var o = F(e.target);
    ...
    function It(t, e, n, r) {
        var i = new Mt(e), o = e.cue, s = Pt(o), a = [];
        if (o.snapToLines) {
            var l;
            switch (o.vertical) {
                case"":
    ...
    function $t() {
        ...
        if ("string" == typeof a) $t(t, Hr[a], n, i, o, s); else if (a) {
            var c = a(i);
    ...
    function re(t, e, n) {
        ...
        var s = En.getComponent("Player"), a = new s(r, e, n);
    ...
    var de = ae, fe = le.navigator && le.navigator.userAgent || "", ve = /AppleWebKit\/([\d.]+)/i.exec(fe),
        ...
        De = h() && "backgroundSize" in le.document.createElement("video").style, Le = (Object.freeze || Object)({
            ...
            return t.raw = e, t
        }, We = Object.prototype.toString, Ue = function (t) {
            return i(t) ? Object.keys(t) : []
        }, ze = void 0, Xe = "info", qe = [], Ke = function (t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !!Oe && Oe < 11, r = ze.levels[Xe],
                o = new RegExp("^(" + r + ")$");
    ...
    var on = ["touchstart", "touchmove"],
        sn = (Object.freeze || Object)({fixEvent: z, on: X, off: q, trigger: K, one: Y}), an = !1, ln = void 0,
        cn = function () {
            if (h()) {
    ...
    fn.prototype.allowedEvents_ = {}, fn.prototype.on = function (t, e) {
        ...
        }, X(this, t, e), this.addEventListener = n
        ...
        var n = this.addEventListener;
        this.addEventListener = function () {
        }, Y(this, t, e), this.addEventListener = n
    }, fn.prototype.trigger = function (t) {
        var e = t.type || t;
        "string" == typeof t && (t = {type: e}), t = z(t), this.allowedEvents_[e] && this["on" + e] && this["on" + e](t), K(this, t)
    ...
    var vn = function (t) {
        ...
        on: function () {
            ...
            var i = bn(this, n), o = i.isTargetingSelf, s = i.target, a = i.type, l = i.listener;
            if (Tn(s, "on", a, l), !o) {
                var c = function () {
                    return t.off(s, a, l)
                };
            ...
            if (!t || yn(t)) q(this.eventBusEl_, t, e); else {
                var r = t, i = e;
        ...
        function t(e, n, r) {
            ...
            this.name_ = n.name || null, n.el ? this.el_ = n.el : !1 !== n.createEl && (this.el_ = this.createEl()), !1 !== n.evented && $(this, {eventBusKey: this.el_ ? "el_" : null}), J(this, this.constructor.defaultState), this.children_ = [], this.childIndex_ = {}, this.childNameIndex_ = {}, !1 !== n.initChildren && this.initChildren(), this.ready(r), !1 !== n.reportTouchActivity && this.enableTouchActivity()
        }
    ...
    for (var wn = {}, Sn = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], xn = Sn[0], jn = void 0, An = 0; An < Sn.length; An++) if (Sn[An][1] in de) {
        jn = Sn[An];
        break
    }
    if (jn) for (var Pn = 0; Pn < jn.length; Pn++) wn[xn[Pn]] = jn[Pn];
    ...
    }, Ln = {textTracksToJson: In, jsonToTextTracks: Dn, trackToJson_: Mn}, Rn = "vjs-modal-dialog", Bn = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
            return i.opened_ = i.hasBeenOpened_ = i.hasBeenFilled_ = !1, i.closeable(!i.options_.uncloseable), i.content(i.options_.content), i.contentEl_ = v("div", {className: Rn + "-content"}, {role: "document"}), i.descEl_ = v("p", {
    ...
    Bn.prototype.options_ = {pauseOnOpen: !0, temporary: !0}, En.registerComponent("ModalDialog", Bn);
    var Fn = function (t) {
        function e() {
    ...
    Fn.prototype.allowedEvents_ = {change: "change", addtrack: "addtrack", removetrack: "removetrack"};
    ...
    var vr = function (t, e) {
            ...
            function e() {
                ...
                var o = tt(i, {kind: $n[i.kind] || "subtitles", language: i.language || i.srclang || ""}),
                    s = Jn[o.mode] || "disabled", a = o.default;
                "metadata" !== o.kind && "chapters" !== o.kind || (s = "hidden");
                var l = n = Ve(this, t.call(this, o));
                if (l.tech_ = o.tech, Pe) for (var c in e.prototype) "constructor" !== c && (l[c] = e.prototype[c]);
                l.cues_ = [], l.activeCues_ = [];
                var u = new Kn(l.cues_), h = new Kn(l.activeCues_), p = !1, d = pn(l, function () {
    ...
    var mr = function (t) {
        function e() {
            var n, r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            Be(this, e);
            var o = tt(i, {kind: Gn[i.kind] || ""}), s = n = Ve(this, t.call(this, o)), a = !1;
            if (Pe) for (var l in e.prototype) "constructor" !== l && (s[l] = e.prototype[l]);
        ...
        function e() {
            var n, r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            Be(this, e);
            var o = tt(i, {kind: Yn[i.kind] || ""}), s = n = Ve(this, t.call(this, o)), a = !1;
            if (Pe) for (var l in e.prototype) "constructor" !== l && (s[l] = e.prototype[l]);
        ...
        return Fe(e, t), e
    }(Qn), br = 0, Tr = 2, Cr = function (t) {
        function e() {
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            Be(this, e);
            var r = Ve(this, t.call(this)), i = void 0, o = r;
            if (Pe) {
                o = de.createElement("custom");
                for (var s in e.prototype) "constructor" !== s && (o[s] = e.prototype[s])
            }
    ...
    Cr.prototype.allowedEvents_ = {load: "load"}, Cr.NONE = br, Cr.LOADING = 1, Cr.LOADED = Tr, Cr.ERROR = 3;
    var kr = {
        audio: {ListClass: Wn, TrackClass: mr, capitalName: "Audio"},
        video: {ListClass: zn, TrackClass: _r, capitalName: "Video"},
        text: {ListClass: Xn, TrackClass: gr, capitalName: "Text"}
    };
    ...
    var xr = {"&amp;": "&", "&lt;": "<", "&gt;": ">", "&lrm;": "‎", "&rlm;": "‏", "&nbsp;": " "},
        ...
        Ar = {v: "title", lang: "lang"}, Pr = {rt: "ruby"},
    ...
    Dt.processCues = function (t, e, n) {
        ...
        if (r.style.position = "absolute", r.style.left = "0", r.style.right = "0", r.style.top = "0", r.style.bottom = "0", r.style.margin = "1.5%", n.appendChild(r), function (t) {
            ...
            var i = [], o = Mt.getSimpleBoxPosition(r), s = Math.round(.05 * o.height * 100) / 100,
    ...
    var Nr = Dt, Mr = "auto", Ir = {"": !0, lr: !0, rl: !0}, Dr = {start: !0, middle: !0, end: !0, left: !0, right: !0};
    Ft.prototype.getCueAsHTML = function () {
        return WebVTT.convertCueToDOMTree(window, this.text)
    };
    var Lr = Ft, Rr = {"": !0, up: !0}, Br = Wt, Fr = t(function (t) {
        var e = t.exports = {WebVTT: Nr, VTTCue: Lr, VTTRegion: Br};
    ...
    var Hr = {}, Wr = {buffered: 1, currentTime: 1, duration: 1, seekable: 1, played: 1}, Ur = {setCurrentTime: 1},
        zr = function t(e) {
            if (Array.isArray(e)) {
                var n = [];
            ...
            function e(n, r, i) {
                Be(this, e);
                var o = tt({createEl: !1}, r), s = Ve(this, t.call(this, n, o, i));
    ...
    ui.prototype.options_ = {children: []}, Oe && !(Oe > 8) || be || Ce || ui.prototype.options_.children.push("timeTooltip"), En.registerComponent("PlayProgressBar", ui);
    var hi = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    hi.prototype.options_ = {children: ["timeTooltip"]}, En.registerComponent("MouseTimeDisplay", hi);
    ...
    var fi = function (t) {
        ...
        return Fe(e, t), e.prototype.createEl = function () {
            ...
            var e = this.getChild("seekBar"), n = e.getChild("mouseTimeDisplay"), r = e.el(), i = A(r), o = O(r, t).x;
    ...
    fi.prototype.options_ = {children: ["seekBar"]}, En.registerComponent("ProgressControl", fi);
    var vi = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    _i.prototype.options_ = {children: ["volumeBar"]}, En.registerComponent("VolumeControl", _i);
    var bi = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    Ti.prototype.options_ = {children: ["muteToggle", "volumeControl"]}, En.registerComponent("VolumePanel", Ti);
    var Ci = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    var ki = function (t) {
        ...
        return Fe(e, t), e.prototype.update = function () {
            ...
            var t = new Ci(this.player_, {menuButton: this});
    ...
    var Ei = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = r.tracks, o = Ve(this, t.call(this, n, r));
    ...
    var ji = function (t) {
        ...
        return Fe(e, t), e.prototype.createItems = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Si, n = void 0;
    ...
    var Oi = function (t) {
        function e(n, r, i) {
            Be(this, e);
            var o = Ve(this, t.call(this, n, r, i)), s = n.textTracks(), a = pn(o, o.handleTracksChange);
    ...
    var Ii = function (t) {
        ...
        return Fe(e, t), e.prototype.buildCSSClass = function () {
            ...
            var e = [];
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || (e.push(new Mi(this.player_, {kind: this.kind_})), this.hideThreshold_ += 1), t.prototype.createItems.call(this, e)
        }, e
    }(ji);
    ...
    var Li = function (t) {
        ...
        return Fe(e, t), e.prototype.buildCSSClass = function () {
            ...
            var e = [];
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || (e.push(new Mi(this.player_, {kind: this.label_})), this.hideThreshold_ += 1), e = t.prototype.createItems.call(this, e, Di)
        }, e
    }(ji);
    ...
    var Bi = function (t) {
        ...
        return Fe(e, t), e.prototype.buildCSSClass = function () {
            ...
            for (var e = this.player_.audioTracks(), n = 0; n < e.length; n++) {
                var r = e[n];
                t.push(new Ri(this.player_, {track: r, selectable: !0}))
            }
            return t
        }, e
    }(Ei);
    ...
    var Vi = function (t) {
        ...
        return Fe(e, t), e.prototype.createEl = function () {
            ...
            var t = new Ci(this.player()), e = this.playbackRates();
            if (e) for (var n = e.length - 1; n >= 0; n--) t.addChild(new Fi(this.player(), {rate: e[n] + "x"}));
            return t
    ...
    Ui.prototype.options_ = {children: ["playToggle", "volumePanel", "currentTimeDisplay", "timeDivider", "durationDisplay", "progressControl", "liveDisplay", "remainingTimeDisplay", "customControlSpacer", "playbackRateMenuButton", "chaptersButton", "descriptionsButton", "subsCapsButton", "audioTrackButton", "fullscreenToggle"]}, En.registerComponent("ControlBar", Ui);
    var zi = function (t) {
        function e(n, r) {
            Be(this, e);
            var i = Ve(this, t.call(this, n, r));
    ...
    var Xi = ["#000", "Black"], qi = ["#00F", "Blue"], Ki = ["#0FF", "Cyan"], Yi = ["#0F0", "Green"],
        Gi = ["#F0F", "Magenta"], $i = ["#F00", "Red"], Ji = ["#FFF", "White"], Qi = ["#FF0", "Yellow"],
    ...
    var io = He(["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."], ["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."]),
        oo = function (t) {
            function e(n, r) {
                Be(this, e);
                var i = Ve(this, t.call(this, n, r)), o = n.source, s = !1;
            ...
            return Fe(e, t), e.prototype.dispose = function () {
                ...
                var t = this;
                kr.names.forEach(function (e) {
                    var n = kr[e], r = t.el()[n.getterName], i = t[n.getterName]();
                ...
                if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
                    if (t) {
                        ...
                        var i = this.options_.tag && k(this.options_.tag), o = tt({}, i);
    ...
    }, oo.registerSourceHandler(oo.nativeSourceHandler), Vr.registerTech("Html5", oo);
    var uo = He(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
        ...
        po = function (t) {
            function e(n, i, o) {
                if (Be(this, e), n.id = n.id || "vjs_video_" + B(), i = r(e.getTagSettings(n), i), i.initChildren = !1, i.createEl = !1, i.evented = !1, i.reportTouchActivity = !1, !i.language) if ("function" == typeof n.closest) {
                ...
                l.cache_ = {}, l.poster_ = i.poster || "", l.controls_ = !!i.controls, l.cache_.lastVolume = 1, n.controls = !1, n.removeAttribute("controls"), l.scrubbing_ = !1, l.el_ = l.createEl(), $(l, {eventBusKey: "el_"});
                var u = tt(l.options_);
                if (i.plugins) {
                    var h = i.plugins;
                ...
                var p = oe.split(".")[0];
                return l.addClass("vjs-v" + p), l.userActive(!0), l.reportUserActivity(), l.listenForUserActivity_(), l.on("fullscreenchange", l.handleFullscreenChange_),
                    l.on("stageclick", l.handleStageClick_), l.changingSrc_ = !1, l.playWaitingForReady_ = !1, l.playOnLoadstart_ = null, l.forceAutoplayInChrome_(), l
            }
    ...
    var vo = {}, yo = function (t) {
        ...
        var n = function () {
            _o(this, {name: t, plugin: e, instance: null}, !0);
            var n = e.apply(this, arguments);
            return mo(this, t), _o(this, {name: t, plugin: e, instance: n}), n
        };
        ...
        return t.prototype.version = function () {
            ...
            if (yo(e)) Ye.warn('A plugin named "' + e + '" already exists. You may want to avoid re-registering plugins!'); else if (po.prototype.hasOwnProperty(e)) throw new Error('Illegal plugin name, "' + e + '", cannot share a name with an existing player method!');
