        ...
        <div id="showOrNot">
            <div class="music_right_header">
                <div class="songListImgDiv">
                    <img alt="图片" src="${pageContext.request.contextPath}/index/images/songlistimg.jpg" height="200"
                         width="200">
                </div>
            ...
            <div class="write_songlist_comment">
                <img align="top" id="user_header_photo" src="${pageContext.request.contextPath}/index/images/01.jpg"
                     width="50" height="50"/>
                <textarea class="comtext" id="songlist_comment_textarea" placeholder="评论" rows="4" cols="85"></textarea>
                <c:if test="${sessionScope.indexUser!=null}">
